...
//NSString *const API_BASE_URL = @"http://smile.abdn.ac.uk/smile-server/api-1.0";
NSString *const API_BASE_URL = @"http://smile.abdn.ac.uk/smile-server/api-1.1";
...
NSString *const JSON_INGREDIENT_CONTEXT_KEY = @"context";
...
NSString *const ATTRIBUTE_INGREDIENT_TITLE_KEY=@"description";
